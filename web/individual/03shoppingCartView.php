...
<li><span class="identifier">Bag of Gold</span>
    <span><img src="../images/bagOfGold.png" alt="Bag of Gold"></span>
    ...
    <?php echo '<span class="total">'.$bagOfGold.->total.'</span>'?>
</li>
<li>
    <span class="identifier">Two-Headed Cobra</span>
        <span><img src="../images/twoHeadedCobra.png" alt="Two-headed Cobra"></span>
    ...
    <?php echo '<span class="total">'.$twoHeadedCobra.->total.'</span>'?>
</li>
<li><span class="identifier">300 lb Bag of Bean Burritos</span>
    <span><img src="../images/burritos.png" alt="Burritos"></span>
    ...
    <?php echo '<span class="total">'.$burrito.->total.'</span>'?>
</li>
<li><span class="identifier">Life-size Statue of Andre the Giant made of Swiss Cheese</span>
    <span><img src="../images/statue.png" alt="Life-size Statue of Andre the Giant made of Swiss Cheese"></span>
    ...
    <?php echo '<span class="total">'.$statue.->total.'</span>'?>
</li>
<li><span class="identifier">Roll of Paper Towels</span>
    <span><img src="../images/paperTowels.png" alt="Roll of Paper Towels"></span>
    ...
    <?php echo '<span class="total">'.$paperTowel.->total.'</span>'?>
</li>
<li class="disabled"><span class="identifier">Ark of the Covenant (Out of Stock)</span>
    <span><img src="../images/ark.png" alt="Ark of the Covenant"></span>
    ...
    <?php echo '<span class="total">'.$ark.->total.'</span>'?>
</li>
